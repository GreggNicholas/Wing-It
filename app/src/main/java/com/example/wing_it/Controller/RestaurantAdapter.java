...
public class RestaurantAdapter extends RecyclerView.Adapter<RestaurantViewHolder> {
    ...
    public RestaurantAdapter(List<RestaurantList> restaurantLists, ViewHolderClick mapInterface) {
    ...
    public void onBindViewHolder(@NonNull RestaurantViewHolder restaurantViewHolder, int i) {
        restaurantViewHolder.OnBind(restaurantLists.get(i),mapInterface);
